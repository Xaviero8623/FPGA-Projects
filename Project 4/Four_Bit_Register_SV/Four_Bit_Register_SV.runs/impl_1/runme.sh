...
HD_PWD='C:/Users/xavie/Desktop/VHDL_Adventures/Project 4/Four_Bit_Register_SV/Four_Bit_Register_SV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Bit_Register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Four_Bit_Register.tcl -notrace
