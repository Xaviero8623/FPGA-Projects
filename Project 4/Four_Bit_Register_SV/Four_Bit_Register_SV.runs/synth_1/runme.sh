...
HD_PWD='C:/Users/xavie/Desktop/VHDL_Adventures/Project 4/Four_Bit_Register_SV/Four_Bit_Register_SV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Bit_Register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Four_Bit_Register.tcl
