...
HD_PWD='C:/Users/xavie/Desktop/VHDL_Adventures/Project 3/LED_and_Gate_SV/LED_and_Gate_SV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_and_Gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_and_Gate.tcl
