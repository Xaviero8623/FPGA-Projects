...
HD_PWD='C:/Users/xavie/Desktop/VHDL_Adventures/Project 3/LED_and_Gate_SV/LED_and_Gate_SV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_and_Gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_and_Gate.tcl -notrace
